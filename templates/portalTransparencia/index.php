...
<title>Div flutuante centro da tela.</title>
  ...
  <body>   
    ...
    <!-- <div class="headermenucontent">
      <img class="togglemobilemenu close_menu" src="<?php //echo $pathIMG; ?>close_menu.svg">
      <div class="itens">            
			...
			<div data-aba-search="8" class="aba selected">
				<div class="row">
					...
					<div class="col-9 consultacontainer">
						...
						<div class="option margin" id="nomeResultado">
							
						</div>
						<div class="box noborder nopadding block" id="id_caixa_botao_impressao">
							<a href="#conteudo" role="button"  class="box BotaoPDF" id="botaoBaixarPDF">
								<img src="<?php echo $pathIMG; ?>branco_download.svg">
								PDF
							</a>
							<a href="#conteudo" role="button"  class="box BotaoXML" id="botaoBaixarXML">
								<img src="<?php echo $pathIMG; ?>branco_download.svg">
								XML
							</a>
							<a href="#conteudo" role="button"  class="box BotaoCSV" id="botaoBaixarCSV">
								<img src="<?php echo $pathIMG; ?>branco_download.svg">
								CSV
							</a>
							<a href="#conteudo" role="button"  class="box" BotaoIMPRIMIR" id="botaoBaixarIMPRIMIR">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9">
                    ...
                    <div class="row">
                        ...
                        <a class="botao box small c1 h72"  href="https://www4.trf5.jus.br/julia/entrar">JULIA</a>
