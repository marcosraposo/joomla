...
<body>
    <div class="headermenu mobileonly">
        <img class="logo" src="<?= $pathIMG; ?>logo.svg">
    ...
    <div class="container hidemobile">
        <div class="row topo">
            <div class="col-6 links nopadding">
        ...
        <div class="row">
            ...
            <div class="col-8 text-center">
                <img style="width:500px" src="<?= $pathIMG; ?>trf5-completo.svg" alt="Tribunal Regional Federal 5ª Região">
            </div>
        ...
        <div class="row">
            <div class="col-12 text-right">
                <a href="index.php/ouvidoria" style="text-decoration:none;  font-size: 14px;">SIC – Serviço de Informação ao Cidadão</a>
            </div>
        </div>
        <div class="row menu_index">
            <!-- MENU PRINCIPAL -->
            <jdoc:include type="modules" name="menuPrincipal" style="none" />
        </div>
    </div>
    ...
    <div class="container">
        <div class="row nopadding">
            <div class="col-12 nopadding colmainbox">
                <a href="index.php/pesquisa-processual" class="main_box duplo" style="color: #fff; text-decoration: none;">
                    <div class="icone"><img src="<?= $pathIMG; ?>lupa.svg"></div>
                    Busca Processual
                </a>
                <a class="main_box split" href="index.php/portal-transparencia" style="text-decoration: none; color: #fff">
                    <div class="icone"><img style="width: 200px;max-width: 60px;" src="<?= $pathIMG; ?>branco_olho.svg"></div>
                    Portal da transparência
                </a>
                <div class="main_box split" onclick="location.href='index.php/noticias'">
                    <div class="icone"><img src="<?= $pathIMG; ?>conversa.svg"></div>
                    Mais notícias
                </div>
            </div>
        </div>
        ...
        <div class="row m5">
            <div class="col-12 nopadding">
                ...
                <div class="main_box_medio duplo cnj">
                    <div class="left">
                        <div class="cont">
                            <a href="index.php/pje">
                                <div class="icone"><img src="<?= $pathIMG; ?>pje.svg"></div>
                            </a>
                        </div>
                    </div>
                    <div class="center">
                        <div class="cont">
                            <a href="index.php/pje" style="text-decoration: none; color: #fff;">
                    ...
                    <div class="right">
                        <div class="cont">
                            <a href="index.php/pje" style="text-decoration: none; color: #fff;">
                                <div class="box" style="text-decoration: none; color: #fff; display: block; width: 118px; height: 24px">O que é PJe?</div>
                                <div class="box" style="text-decoration: none; color: #fff; display: block; width: 118px; height: 24px">Acesso ao PJe?</div>
                                <div class="box" style="text-decoration: none; color: #fff; display: block; width: 118px; height: 24px">Consulta Pública</div>
                            </a>
                        </div>
                    </div>
                </div>
