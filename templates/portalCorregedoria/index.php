    ...
    <div class="container hidemobile">
      <div class="row topo">
          ...
          <div class="col-6 text-right acessibilidade">
            ...
            <img class="btnVoltarNormal" src="<?php echo $pathIMG; ?>acessibilidade_back.svg" alt="Voltar ao Normal"> <img class="btnTradutor" src="<?= $pathIMG; ?>acessibilidade_t.svg" title="Tradutor"> </div> </div> <div id="barraIdiomas" class="hidemobile" style="display:none; margin-right:9px ; font-size: 10px; text-align: end;"> <a href="javascript:trocarIdioma('en')">Inglês</a> / <a href="javascript:trocarIdioma('es')">Espanhol</a> / <a href="javascript:trocarIdioma('pt')">Português</a> <br>A tradução não é de responsabilidade do TRF5. </div>
    </div>      
