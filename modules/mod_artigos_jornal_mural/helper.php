...
abstract class ModJornalMural
{
	
	public static function getList(&$params, $ano){
		...
		if($params->get('url_webservice') != ""){
			try {
				...
				//$arguments = array('getJornalMural' => array('arg0' => $ano));
				//$items['servico'] =	 $client->__soapCall("getJornalMural", $arguments ); 
			
				
				//$items['servico'] =	$response = json_decode(json_encode($client->getJornalMural()), True);
