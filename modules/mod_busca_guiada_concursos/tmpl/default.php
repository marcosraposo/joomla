			...
			<div class="row">
                ...
                <div class="col-9 consultacontainer">
					...
					<div class="option margin">
                        <div class="chevron volta" onclick="javascript:resultadoBuscaGuiada('concursos-e-selecoes','1','0','avancar')";><</div>
                        Escolha uma opção
                    </div>
						...
						foreach($buscaGuiadaServico as $retorno){
							foreach($retorno->categoria as $botoes){
								if(is_object($botoes)){ 
									...
									<?php }else{ ?>
										<div class="box" onclick="javascript:resultadoBuscaGuiada('<?php echo $botoes->id; ?>','<?php echo "concursos-e-selecoes/".$botoes->id;?>','<?php echo $nivel+1; ?>','','<?php echo $botoes->title; ?>', 'avancar')";>
											<img src="../templates/portalTransparencia/images/folha.svg">
											<?php echo $botoes->title; ?>
										</div>
							  <?php }
										...
										if(is_object($botoes)){
											if($botoes->exibe){
												if(!empty($botoes->sv) && $botoes->sv != ""){ ?>
													<div class="box" onClick="window.location.href='../index.php/concursos-e-selecoes/resultado-pdf?/id=<?php echo $botoes->id; ?>&MOD=<?php echo $botoes->sv; ?>&niveis=<?php echo $tituloNiveis; ?>'" >
														<img src="../templates/portalTransparencia/images/folha.svg">
														<?php echo $botoes->title; ?>
													</div>
													<?php 
