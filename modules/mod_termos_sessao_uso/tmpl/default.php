                    ...
                    <tr>
                        <td>
                            ...
                            <?php if (!empty($listaPdf['exibe'])) :
                                $texto .= "<a href='index.php/gestao-orcamentaria/resultado-pdf?/id=" . $listaPdf['codigo'] . "&MOD=SV1&niveis=" . urlencode("CONVÊNIOS E ACORDOS/Termos de Cessão de Uso/" . $horarioAno2[2] . "/" . $listDados['instituicao'] . "/" . $listaPdf['descricaoArquivo']) . "'>";
                                $texto .= $listaPdf['descricaoArquivo'] . "</a>";
                                ?>
                            <a href="index.php/gestao-orcamentaria/resultado-pdf?/id=<?php echo $listaPdf['codigo']; ?>&MOD=SV1&niveis=<?php echo urlencode('CONVÊNIOS E ACORDOS/Termos de Cessão de Uso/' . $horarioAno2[2] . '/' . $listDados['instituicao'] . "/" . $listaPdf['descricaoArquivo']) ?>">
                        ...
                        <td>
                            <?php foreach ($listDados['aditivos'] as $listAditivo) :
                                $texto .= "<br>";
                                $texto .= "<a href='index.php/gestao-orcamentaria/resultado-pdf?/id=" . $listAditivo['codigo'] . "&MOD=SV12&niveis=" . urlencode("CONVÊNIOS E ACORDOS/Termos de Cessão de Uso/" . $horarioAno2[2] . "/" . $listDados['instituicao'] . "/" . $listAditivo['descricaoArquivo']) . "'>";
                                $texto .= $listAditivo['descricaoArquivo'] . "</a>";
                                ?>
                            <br><a href="index.php/gestao-orcamentaria/resultado-pdf?/id=<?php echo $listAditivo['codigo']; ?>&MOD=SV12&niveis=<?php echo urlencode('CONVÊNIOS E ACORDOS/Termos de Cessão de Uso/' . $horarioAno2[2] . '/' . $listDados['instituicao'] . "/" . $listAditivo['descricaoArquivo']) ?>"><?php echo $listAditivo['descricaoArquivo']; ?></a>
                            <?php endforeach;
                        $texto .= "</td>"
                        ?>
                        </td>
